"""
Django settings for wiwan_app project.
...
SECRET_KEY = 'django-insecure-^0-3g(7=tz71i2o!nup%j^c4-+s*r+sd^j6!!oy9xxcpj_y)*d'
...
WSGI_APPLICATION = 'wiwan_app.wsgi.application'
